# -*- coding: utf-8 -*-
"""도현님 v2 DLinear → MLinear.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1XgzlmVhQZpJIWpvoewY8_-4WjxCad6-9
"""
...
class EnhancedNHiTSConfig:
    ...
    out_submission_csv: str = "0819_dlinear_to_mlinear_5model_submission.csv"
...
def get_menu_group(store_name: str, menu_name: str) -> str:
    ...
    if store_type == 'fine_dining' and category in ['alcohol', 'bbq']:
        return 'premium_dining'
    elif store_type == 'casual' and category == 'coffee':
        return 'cafe_drinks'
    elif store_type == 'outdoor' and category == 'bbq':
        return 'outdoor_bbq'
...
if __name__ == "__main__":
    ...
    if cfg.USE_OPTUNA:
        if not HAS_OPTUNA:
            ...
            for name in ["N-HiTS", "PatchTST", "TimesNet", "GRU", "MLinear"]:
    ...
    # ===== 모델 학습 (멀티 폴드 평균 val) =====
    model_names = ["TimesNet", "GRU", "MLinear", "N-HiTS", "PatchTST"]

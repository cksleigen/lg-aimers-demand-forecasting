# =============================================================================
# Notebook 2: MLinear + TSMixer + TCN + GRU 학습
# =============================================================================
...
if __name__ == "__main__":
    ...
    print("=== Notebook 2: MLinear + TSMixer + TCN + GRU 학습 시작 ===")
    ...
    # 📌 이 노트북에서 학습할 모델들만 선택
    model_names = ["MLinear", "TSMixer", "TCN", "GRU"]
    ...
    for name in model_names:
        ...
        base_model = build_final_model_with_best(
            name, cfg_for_model, ds, best_params_all.get(name) if name == "MLinear" else None
        )
    ...
    print("✅ Notebook 3 (MLinear + TSMixer + TCN + GRU) 학습 완료!")
    print("체크포인트가 저장되었습니다. 앙상블 노트북을 실행하세요.")